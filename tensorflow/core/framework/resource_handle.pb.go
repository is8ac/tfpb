...
func (*ResourceHandleProto) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{0} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/resource_handle.proto", fileDescriptor16) }
