...
func (*VariableDef) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{0} }
...
func (*SaveSliceInfoDef) Descriptor() ([]byte, []int) { return fileDescriptor24, []int{1} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/variable.proto", fileDescriptor24) }
