...
func (*OpGenOverride) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{0} }
...
func (*OpGenOverride_AttrDefault) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{0, 0} }
...
func (*OpGenOverride_Rename) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{0, 1} }
...
func (*OpGenOverrides) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{1} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/op_gen_overrides.proto", fileDescriptor13) }
