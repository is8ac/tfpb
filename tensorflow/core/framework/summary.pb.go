...
func (*SummaryDescription) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{0} }
...
func (*HistogramProto) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{1} }
...
func (*SummaryMetadata) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{2} }
...
func (*SummaryMetadata_PluginData) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{2, 0} }
...
func (*Summary) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{3} }
...
func (*Summary_Image) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{3, 0} }
...
func (*Summary_Audio) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{3, 1} }
...
func (*Summary_Value) Descriptor() ([]byte, []int) { return fileDescriptor18, []int{3, 2} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/summary.proto", fileDescriptor18) }
