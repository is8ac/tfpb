...
func (*AllocationRecord) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{0} }
...
func (*AllocatorMemoryUsed) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{1} }
...
func (*NodeOutput) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{2} }
...
func (*MemoryStats) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{3} }
...
func (*NodeExecStats) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{4} }
...
func (*DeviceStepStats) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{5} }
...
func (*StepStats) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{6} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/step_stats.proto", fileDescriptor17) }
