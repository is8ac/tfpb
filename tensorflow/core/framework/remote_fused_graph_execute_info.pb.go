...
func (*RemoteFusedGraphExecuteInfo) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{0} }
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/remote_fused_graph_execute_info.proto", fileDescriptor15)
}
