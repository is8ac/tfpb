...
import tensorflow16 "tensorflow/core/framework"
...
type BundleHeaderProto struct {
	...
	Version *tensorflow10.VersionDef `protobuf:"bytes,3,opt,name=version" json:"version,omitempty"`
}
...
func (*BundleHeaderProto) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{0} }
...
func (m *BundleHeaderProto) GetVersion() *tensorflow10.VersionDef {
	if m != nil {
		return m.Version
	}
	return nil
...
type BundleEntryProto struct {
	...
	Slices []*tensorflow16.TensorSliceProto `protobuf:"bytes,7,rep,name=slices" json:"slices,omitempty"`
}
...
func (*BundleEntryProto) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{1} }

func (m *BundleEntryProto) GetDtype() tensorflow2.DataType {
	if m != nil {
		return m.Dtype
	}
...
func (m *BundleEntryProto) GetSlices() []*tensorflow16.TensorSliceProto {
	if m != nil {
		return m.Slices
	}
	return nil
...
func init() { proto.RegisterFile("tensorflow/core/protobuf/tensor_bundle.proto", fileDescriptor12) }
