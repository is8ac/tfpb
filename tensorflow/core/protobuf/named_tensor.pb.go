...
type NamedTensorProto struct {
	...
	Tensor *tensorflow5.TensorProto `protobuf:"bytes,2,opt,name=tensor" json:"tensor,omitempty"`
}
...
func (*NamedTensorProto) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (m *NamedTensorProto) GetTensor() *tensorflow5.TensorProto {
	if m != nil {
		return m.Tensor
	}
	return nil
...
func init() { proto.RegisterFile("tensorflow/core/protobuf/named_tensor.proto", fileDescriptor7) }
