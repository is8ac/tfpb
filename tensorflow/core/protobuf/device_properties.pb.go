...
type NamedDevice struct {
	...
	Properties *DeviceProperties `protobuf:"bytes,2,opt,name=properties" json:"properties,omitempty"`
}
...
func (*NamedDevice) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
