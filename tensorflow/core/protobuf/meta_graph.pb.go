...
func (*MetaGraphDef) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (m *MetaGraphDef) GetGraphDef() *tensorflow11.GraphDef {
	if m != nil {
		return m.GraphDef
	}
	return nil
...
type MetaGraphDef_MetaInfoDef struct {
	...
	StrippedOpList *tensorflow8.OpList `protobuf:"bytes,2,opt,name=stripped_op_list,json=strippedOpList" json:"stripped_op_list,omitempty"`
...
func (*MetaGraphDef_MetaInfoDef) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0, 0} }
...
func (m *MetaGraphDef_MetaInfoDef) GetStrippedOpList() *tensorflow8.OpList {
	if m != nil {
...
func (*CollectionDef) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func (*CollectionDef_NodeList) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1, 0} }
...
func (*CollectionDef_BytesList) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1, 1} }
...
func (*CollectionDef_Int64List) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1, 2} }
...
func (*CollectionDef_FloatList) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1, 3} }
...
func (*CollectionDef_AnyList) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1, 4} }
...
func (*TensorInfo) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2} }
...
func (*TensorInfo_CooSparse) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2, 0} }
...
func (*SignatureDef) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{3} }
...
func (*AssetFileDef) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{4} }
...
func init() { proto.RegisterFile("tensorflow/core/protobuf/meta_graph.proto", fileDescriptor6) }
